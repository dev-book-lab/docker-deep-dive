...
- [React Deployment with Docker](https://create-react-app.dev/docs/deployment/)
...
1. 개발 환경과 프로덕션 환경의 Dockerfile을 분리해야 하는가?
2. Multi-stage Build는 항상 사용해야 하는가?
3. Hot Reload가 프로덕션에서도 필요한가?

> 💡 **답변**:
> 
> **1) 개발 vs 프로덕션 Dockerfile 분리:**
> 
> ```
> YES! 반드시 분리해야 함
> 
...
> ```
> 
> **2) Multi-stage Build 사용 시기:**
> 
> ```
> 대부분 YES, 하지만 예외 있음
> 
> ✅ 사용해야:
> - Compiled 언어 (Go, Rust, Java)
>   Build: 2GB → Runtime: 10MB
> 
> - Frontend (React, Vue, Angular)
>   Node + Build Tools → Nginx + Static Files
>   500MB → 20MB
> 
> - 복잡한 빌드 (C/C++ dependencies)
>   컴파일러, 헤더 → 바이너리만
> 
> 예 (Go):
> # Build
...
> 
> 판단 기준:
> 1. 빌드 도구 필요? → Multi-stage
> 2. 이미지 > 500MB? → Multi-stage
> 3. 컴파일 필요? → Multi-stage
> 4. Python/Node만? → 선택사항
> 
> 결론:
> Frontend/Compiled 언어 → 필수
> Backend Script 언어 → 선택
> 개발 환경 → 불필요
> ```
> 
