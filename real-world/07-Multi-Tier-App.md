...
1. 모놀리스와 마이크로서비스 중 어느 것을 선택해야 하는가?
2. 서비스를 얼마나 작게 나눠야 하는가?
3. API Gateway는 필수인가?
...
> 1. 모놀리스로 시작
> 2. 명확한 경계 식별
> 3. 하나씩 분리 (Strangler Pattern)
> 4. 점진적 전환
> 
> "Monolith First" (Martin Fowler)
> → 대부분 모놀리스로 시작 권장
> 
> 중간 지점 (Modular Monolith):
> - 모놀리스 구조
> - 모듈화된 코드
> - 향후 분리 쉬움
> - Best of Both Worlds
...
**[⬅️ 이전: Backup System](./06-Backup-System.md)** | **[홈으로 🏠](../README.md)**
